<script>
	...
	import AxisX from '$lib/components/layercake/AxisX.svg.svelte';
	import AxisY from '$lib/components/layercake/AxisY.svg.svelte';
	import ChartDetails from '$lib/components/bookbans/ChartDetails.svelte';
...
<div class="chart-container" use:inView on:enter={inViewDraw} on:exit={exitViewDraw}>
	<LayerCake
	...
	>
		<Svg>
			<AxisX gridlines={false} {ticks} {formatTick} />
			<AxisY snapBaselineLabel gridlines={true} />
			<Line {inViewTrigger} stroke="black" stroke-width="2" />
		</Svg>
	</LayerCake>
</div>
