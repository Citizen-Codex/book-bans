...
<div class="flex flex-col gap-6 bg-black px-4 py-8 text-white md:px-6">
	<a href={page.data.publisher_url} aria-current="page"><Wordmark /></a>

	<div class="mono-sm mb-1 flex flex-wrap gap-x-6 gap-y-2 text-white">
	...
	<div class="flex w-full flex-wrap items-end justify-between gap-3">
		<div class="mono-xs">2025 Copyright, Citizen Codex LLC.</div>
