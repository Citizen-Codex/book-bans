...
// node_modules/.pnpm/d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/active.js
var root2 = [null];
...
// node_modules/.pnpm/d3-contour@4.0.2/node_modules/d3-contour/src/ascending.js
function ascending_default(a4, b) {
  return a4 - b;
}

// node_modules/.pnpm/d3-contour@4.0.2/node_modules/d3-contour/src/area.js
...
// node_modules/.pnpm/d3-contour@4.0.2/node_modules/d3-contour/src/constant.js
var constant_default5 = (x4) => () => x4;

// node_modules/.pnpm/d3-contour@4.0.2/node_modules/d3-contour/src/contains.js
...
// node_modules/.pnpm/d3-contour@4.0.2/node_modules/d3-contour/src/noop.js
function noop_default() {
}

// node_modules/.pnpm/d3-contour@4.0.2/node_modules/d3-contour/src/contours.js
var cases = [
  [],
  [[[1, 1.5], [0.5, 1]]],
  [[[1.5, 1], [1, 1.5]]],
...
// node_modules/.pnpm/d3-contour@4.0.2/node_modules/d3-contour/src/density.js
function defaultX(d) {
  return d[0];
}
function defaultY(d) {
  ...
  *neighbors(i) {
  ...
  _clipSegment(x0, y0, x1, y1, c0, c1) {
    ...
    while (true) {
      ...
      let x4, y4, c4 = c0 || c1;
      if (c4 & 8) x4 = x0 + (x1 - x0) * (this.ymax - y0) / (y1 - y0), y4 = this.ymax;
      else if (c4 & 4) x4 = x0 + (x1 - x0) * (this.ymin - y0) / (y1 - y0), y4 = this.ymin;
      else if (c4 & 2) y4 = y0 + (y1 - y0) * (this.xmax - x0) / (x1 - x0), x4 = this.xmax;
      else y4 = y0 + (y1 - y0) * (this.xmin - x0) / (x1 - x0), x4 = this.xmin;
      if (c0) x0 = x4, y0 = y4, c0 = this._regioncode(x0, y0);
      else x1 = x4, y1 = y4, c1 = this._regioncode(x1, y1);
    }
  }
  ...
  _project(x0, y0, vx, vy) {
    ...
    if (vy < 0) {
      ...
      if ((c4 = (this.ymin - y0) / vy) < t) y4 = this.ymin, x4 = x0 + (t = c4) * vx;
    } else if (vy > 0) {
      if (y0 >= this.ymax) return null;
      if ((c4 = (this.ymax - y0) / vy) < t) y4 = this.ymax, x4 = x0 + (t = c4) * vx;
    }
    if (vx > 0) {
      if (x0 >= this.xmax) return null;
      if ((c4 = (this.xmax - x0) / vx) < t) x4 = this.xmax, y4 = y0 + (t = c4) * vy;
    } else if (vx < 0) {
      if (x0 <= this.xmin) return null;
      if ((c4 = (this.xmin - x0) / vx) < t) x4 = this.xmin, y4 = y0 + (t = c4) * vy;
    }
    return [x4, y4];
  }
  _edgecode(x4, y4) {
...
function x_default2(x4) {
  ...
  if (typeof x4 !== "function") x4 = constant_default6(x4 == null ? 0 : +x4);
  function force(alpha) {
    for (var i = 0, n = nodes.length, node; i < n; ++i) {
...
function y_default2(y4) {
  ...
  if (typeof y4 !== "function") y4 = constant_default6(y4 == null ? 0 : +y4);
  function force(alpha) {
    for (var i = 0, n = nodes.length, node; i < n; ++i) {
...
// node_modules/.pnpm/d3-hierarchy@3.1.2/node_modules/d3-hierarchy/src/cluster.js
...
// node_modules/.pnpm/d3-hierarchy@3.1.2/node_modules/d3-hierarchy/src/lcg.js
var a2 = 1664525;
var c2 = 1013904223;
var m2 = 4294967296;
...
// node_modules/.pnpm/d3-hierarchy@3.1.2/node_modules/d3-hierarchy/src/array.js
...
// node_modules/.pnpm/d3-hierarchy@3.1.2/node_modules/d3-hierarchy/src/pack/enclose.js
...
// node_modules/.pnpm/d3-hierarchy@3.1.2/node_modules/d3-hierarchy/src/pack/siblings.js
...
// node_modules/.pnpm/d3-hierarchy@3.1.2/node_modules/d3-hierarchy/src/pack/index.js
...
// node_modules/.pnpm/d3-hierarchy@3.1.2/node_modules/d3-hierarchy/src/partition.js
...
function contains_default3(polygon, point6) {
  ...
  for (var i = 0; i < n; ++i) {
    ...
    if (y1 > y4 !== y0 > y4 && x4 < (x0 - x1) * (y4 - y1) / (y0 - y1) + x1) inside = !inside;
    x0 = x1, y0 = y1;
  }
  return inside;
}
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon6)) context.moveTo(0, 0);
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon6 && (padRadius ? +padRadius.apply(this, arguments) : sqrt2(r0 * r0 + r1 * r1)), rc = min3(abs3(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t0, t1;
      if (rp > epsilon6) {
        var p0 = asin(rp / r0 * sin2(ap)), p1 = asin(rp / r1 * sin2(ap));
        if ((da0 -= p0 * 2) > epsilon6) p0 *= cw ? 1 : -1, a00 += p0, a10 -= p0;
...
function area_default4(x0, y0, y1) {
  var x1 = null, defined = constant_default8(true), context = null, curve = linear_default, output = null, path2 = withPath(area);
  x0 = typeof x0 === "function" ? x0 : x0 === void 0 ? x3 : constant_default8(+x0);
  y0 = typeof y0 === "function" ? y0 : y0 === void 0 ? constant_default8(0) : constant_default8(+y0);
  y1 = typeof y1 === "function" ? y1 : y1 === void 0 ? y3 : constant_default8(+y1);
  function area(data) {
  ...
  area.x = function(_) {
    return arguments.length ? (x0 = typeof _ === "function" ? _ : constant_default8(+_), x1 = null, area) : x0;
  };
  area.x0 = function(_) {
    return arguments.length ? (x0 = typeof _ === "function" ? _ : constant_default8(+_), area) : x0;
  };
  area.x1 = function(_) {
    return arguments.length ? (x1 = _ == null ? null : typeof _ === "function" ? _ : constant_default8(+_), area) : x1;
  };
  area.y = function(_) {
    return arguments.length ? (y0 = typeof _ === "function" ? _ : constant_default8(+_), y1 = null, area) : y0;
  };
  area.y0 = function(_) {
    return arguments.length ? (y0 = typeof _ === "function" ? _ : constant_default8(+_), area) : y0;
  };
  area.y1 = function(_) {
    return arguments.length ? (y1 = _ == null ? null : typeof _ === "function" ? _ : constant_default8(+_), area) : y1;
  };
...
function pie_default() {
  var value = identity_default3, sortValues = descending_default, sort2 = null, startAngle = constant_default8(0), endAngle = constant_default8(tau5), padAngle = constant_default8(0);
  function pie(data) {
...
function areaRadial_default() {
  var a4 = area_default4().curve(curveRadialLinear), c4 = a4.curve, x0 = a4.lineX0, x1 = a4.lineX1, y0 = a4.lineY0, y1 = a4.lineY1;
...
function link(curve) {
  ...
  link2.x = function(_) {
    return arguments.length ? (x4 = typeof _ === "function" ? _ : constant_default8(+_), link2) : x4;
  };
  link2.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default8(+_), link2) : y4;
  };
